...
namespace Version3
{
    class Subject3
    {
        ...
        public firstSemester3 oneSemester;
        public secondSemester3 otherSemester;

        //конструктори
        public Subject3(string nameSubject, string fullNamelecturer, int numberLessons)
        {
            this.nameSubject = nameSubject;
            this.fullNamelecturer = fullNamelecturer;
            this.numberLessons = numberLessons;
            oneSemester = new firstSemester3(numberLessons);
            otherSemester = new secondSemester3(numberLessons);
        }
        public Subject3()
        {
            Console.WriteLine("Предмет без інфомації був створений");
        }
        public Subject3(Subject3 previous)
        {
    ...
    class firstSemester3
    {
        ...
        public firstSemester3(int numberLessons)
        {
    ...
    class secondSemester3
    {
        ...
        public secondSemester3(int numberLessons)
        {
