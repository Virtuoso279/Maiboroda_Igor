...
namespace Project
{
    interface IGroup
    {
        void printGroupInform();
        void printGroupPoints(int numberLabWorks, int numberHomeWorks);
        void printGroupAttending(int semestr, int numberLessons, Subject OOP);
        void changeAttendance(int numberLessons);
        void changePoints(int numberLabWorks, int numberHomeWorks);
        void generatingGroup(Random element);
    }
    ...
    class Group : IGroup
    {
        ...
        //конструктори
        public Group(string faculty, string specialty, int courseNumber, string nameGroup, int numberStudents)
        {
            ...
            group = new Student[numberStudents];
        ...
        public void printGroupAttending(int semestr, int numberLessons, Subject OOP)
        {
            Console.WriteLine(new string('-', 70));
