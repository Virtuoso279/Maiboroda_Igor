...
namespace Project
{
    interface IPoints
    {
        void randomMarks(Random element, int maxLabMark, int maxHomeWorkMark, int maxProjectMark, int maxActivity, int maxExtraPoints);
        void printMarksStudent();
        void calculateSumPoints();
    }
    ...
    class Points : IPoints
    {
        ...
        //конструктори
        public Points(int[] labWorks, int numberLabWorks, int[] homeWorks, int numberHomeWorks, int project, int activity, int extraPoints)
        {
        ...
        public Points(int numberLabWorks, int numberHomeWorks)
        {
            this.numberHomeWorks = numberHomeWorks;
            this.numberLabWorks = numberLabWorks;
