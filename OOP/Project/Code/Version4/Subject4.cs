...
namespace Version4
{
    class Subject4
    {
        ...
        public firstSemester4 oneSemester;
        public secondSemester4 otherSemester;

        //конструктори
        public Subject4(string nameSubject, string fullNamelecturer, int numberLessons)
        {
            this.nameSubject = nameSubject;
            this.fullNamelecturer = fullNamelecturer;
            this.numberLessons = numberLessons;
            oneSemester = new firstSemester4(numberLessons);
            otherSemester = new secondSemester4(numberLessons);
        }
        public Subject4()
        {
            Console.WriteLine("Предмет без інфомації був створений");
        }
        public Subject4(Subject4 previous)
        {
    ...
    class firstSemester4
    {
        ...
        //конструктори
        public firstSemester4(int numberLessons)
        {
    ...
    class secondSemester4
    {
        ...
        //конструктори
        public secondSemester4(int numberLessons)
        {
