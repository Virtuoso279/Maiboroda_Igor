...
namespace Version4
{
    class Points4
    {
        ...
        //конструктори
        public Points4(int[] labWorks, int numberLabWorks, int[] homeWorks, int numberHomeWorks, int project, int activity, int extraPoints)
        {
        ...
        public Points4(int numberLabWorks, int numberHomeWorks)
        {
            this.numberHomeWorks = numberHomeWorks;
            this.numberLabWorks = numberLabWorks;
