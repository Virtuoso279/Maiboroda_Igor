...
namespace Version4
{
    class Group4
    {
        ...
        //конструктори
        public Group4(string faculty, string specialty, int courseNumber, string nameGroup, int numberStudents)
        {
            ...
            group = new Student4[numberStudents];
            Console.WriteLine($"Група {nameGroup} була створена");
        }
        public Student4 this[int index]
        {
        ...
        public void printGroupAttending(int semestr, int numberLessons, Subject4 OOP)
        {
            Console.WriteLine(new string('-', 70));
